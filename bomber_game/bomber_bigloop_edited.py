...
CANVAS_WIDTH = 1000
CANVAS_HEIGHT = 700
SPACING = 200#edited here for the rightmost building problem
...
building_xpos = []
building_rects = []
building_width = SPACING * 0.8#edited here
...
while prog_running:
    if seen_event:
        ...
        if ev.char == ' ':
            ...
            if not bomb_falling:
                bomb_falling = True
                bomb_x = plane_x + 50#edited here, the nose bomb problem
                bomb_y = plane_y + 50
        elif ev.char == 'q':
            prog_running = False
        elif ev.char == 'n':
    ...
    if game_running:
        ...
        #have we landed yet?
        if plane_body_pos[1] > CANVAS_HEIGHT and plane_body_pos[0] < 20:#edited here, next level solved
            game_running = False
            won = True
            score = score + 1000
        ...
        if bomb_falling:
            ...
            for building_num in range(0, 1200//SPACING):
                ...
                elif bomb_y > CANVAS_HEIGHT:#edited here to solve the bomb falling problem
                    bomb_falling = False
